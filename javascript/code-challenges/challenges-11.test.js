...
------------------------------------------------------------------------------------------------ */
// Attribution: This solution was crafted by Jim Doyle and shared in code review
...
const count = (target, input) => {
  ...
  let filteredArray = input.filter(function (val, idx) {
    return !(val = target);
  });
  for.Each(filteredArray) // count the index    
  };
...
// Attribution: This solution was crafted by Jim Doyle and shared in code review
// FLAG-TO-SELF: revisit this one later and streamline it!
